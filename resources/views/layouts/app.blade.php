                    ...
                    <ul class="navbar-nav mx-auto flex-row justify-content-around">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle notification-button" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <span class="notification-bubble position-absolute top-0 start-50 translate-middle p-1 bg-danger border border-light rounded-circle" @if(count($notifications)) style="display: none" @if((strtotime($notifications[0]->updated_at))<(strtotime(Auth::user()->notification_read_at))) style="display: none" @endif @endif>
