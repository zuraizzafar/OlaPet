        ...
        <div id="app" class="container-fluid">
            ...
            <div class="row">
                <div class="col-2 col-md-3 px-0">
                    <div class="d-flex flex-column flex-shrink-0 p-1 p-md-3 bg-white me-sm-5 vh-100 overflow-auto">
                        ...
                        <ul class="nav nav-pills flex-column mb-auto">
                            <li class="nav-item mb-2">
                                <a href="{{ route('admin_dashboard') }}" class="nav-link text-center text-md-start link-dark @if(Route::currentRouteName()=='admin_dashboard') active @endif" aria-current="page">
                                    <i class="fa-solid fa-house me-md-2"></i>
                                    <span class="d-none d-md-inline">Home</span>
                                </a>
                            </li>
                            <li class="nav-item mb-2">
                                <a href="{{ route('home') }}" class="nav-link text-center text-md-start link-dark @if(Route::currentRouteName()=='home') active @endif" aria-current="page">
                                    <i class="bi bi-grid-fill me-md-2"></i>
                                    <span class="d-none d-md-inline">Ads</span>
                                </a>
                            </li>
                            <li class="nav-item mb-2">
                                <a href="{{ route('admin_notifications') }}" class="nav-link text-center text-md-start link-dark @if(Route::currentRouteName()=='admin_notifications') active @endif" aria-current="page">
