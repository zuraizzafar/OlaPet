                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-11">
                                <input type="text" class="form-control rounded-pill" id="textAreaExample2" placeholder="Type your message...">
                            </div>
                            <div class="col-1 p-0">

                                <button type="button" class="btn btn-primary btn-rounded rounded-circle" style="padding: 5px 9px;"><i class="fa-solid fa-paper-plane"></i></button>
                            </div>
                        </div>
